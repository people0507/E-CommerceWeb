            ...
            <main class="bg-white-500 flex-1 p-3 overflow-hidden">
                    ...
                    <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                        <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                            ...
                            <div class="p-3">
                                <form method="POST" action="{{ route('producer.update',$producers->id) }}" class="w-full">
                                    @csrf
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3">
                                            ...
                                            <input class="appearance-none block w-full bg-gray-200 text-grey-darker border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600"
                                                   name="producer_name" type="text" placeholder="Doe" value ="{{ $producers->producer_name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:flex md:items-center">
                                        <div class="md:w-3/6"></div>
                                            ...
                                            <a href="{{ route('producer.index') }}" class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-2 rounded " >Cancel </a>
                                    </div>
                                </form>
                            </div>
                        </div>

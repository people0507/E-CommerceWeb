            ...
            <main class="bg-white-500 flex-1 p-3 overflow-hidden">
                    ...
                    <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                        <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                            ...
                            <div class="p-3">
                                <form method="POST" action="{{ route('category.update',$categories->id) }}" class="w-full" enctype="multipart/form-data">
                                    @csrf
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3">
                                            ...
                                            <input class="appearance-none block w-full bg-gray-200 text-grey-darker border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600"
                                                   name="category_name" type="text" placeholder="Doe" value ="{{ $categories->category_name }}">
                                        </div>
                                        <div class="w-full md:w-full px-3 my-3">
                                            ...
                                            <input class="appearance-none block w-full bg-gray-200 text-grey-darker border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600"
                                                   name="category_image" type="file" placeholder="Doe"  value ="{{ $categories->category_image }}">
                                                   <img src="{{ asset('images/categories/' . $categories->category_image) }}" alt="Category Image" style="max-width: 50px; max-height: 50px;">
                                        </div>
                                    </div>
